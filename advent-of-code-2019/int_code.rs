...
pub struct IntCodeMachine {
    // Inputs bascially
    code:   std::vec::Vec<i32>,
    inputs: std::vec::Vec<i32>,
    output: std::vec::Vec<i32>,
...
#[allow(dead_code)]
impl IntCodeMachine {
    pub fn new(code: std::vec::Vec<i32>, inputs: std::vec::Vec<i32>,
    output: std::vec::Vec<i32>, inputs_only: bool, ret_on_wait: bool) -> IntCodeMachine {
    ...
    fn single_int_input(&mut self) -> Option<i32> {
        // Check input vector
        ...
        if parsed.is_err() {
            panic!("Parse error to i32 for {}", s);
        }
    ...
    fn store_val(&mut self, val: i32, loc_idx: i32) {
    ...
    fn param_value(&self, idx: i32) -> i32 {
        return (self.code[self.pc] / 10i32.pow((idx + 1) as u32)) % 10;
    }

    fn get_loc(&self, idx: i32) -> usize {
    ...
    pub fn output(&self, idx: usize) -> i32 {
    ...
    /////////////////////////////////////////////
    pub fn run_code(code: std::vec::Vec<i32>) -> i32 {
